...
everything <- read_xlsx(here("Dashboard fun", "data", "Regional TIFF raw out of Access.xlsx"),
                        sheet = "NUTS3")
...
# per hectare data -------------------------------------------------------------
itl1_per_ha <- read_xlsx(here("Dashboard fun", "data", "Regional TIFF raw out of Access.xlsx"),
                        sheet = "NUTS1-ha")
